      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            // Will refer to the starting point as either where the car is or the end point of previous path
            double ref_x = car_x;
            double ref_y = car_y;
            ...
            // Use the previous path's end point as starting reference
              ...
              // Redefine reference state as previous path's end points
            ...
            // Calculate how to break up spline points for moving at desired velocity 
            ...
            // Always output 50 points here
            for(int i = 1; i < 50-prev_size; i++) {
              // 2.24 --> changing from miles per hours to meter per seconds
